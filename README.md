...
<h3>Motivation</h3>
<p>The goal of this project was to extend the battery run-time by switching from a 2.2" 320x240 LCD screen to a 2.13" 250x122 e-Paper screen (from Waveshare). This version uses the same 1200 mAh battery and can play music continuously for over 4.5 straight hours.</p>
...
<p>The bare PC board can be ordered via this link at <a href="https://www.pcbway.com/project/shareproject/ePaper_PiPod_MP3_music_player_a6adf3e1.html">PCBWay</a>. The BoM is part of this repository, under "Hardware."</p>
<ul>
